...
set_module_property NAME dma_write_master
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP "Modular_DMA"
set_module_property AUTHOR JCJB
set_module_property DISPLAY_NAME "Write Master"
...
add_file byte_enable_generator.v {SYNTHESIS SIMULATION}
add_file ST_to_MM_Adapter.v {SYNTHESIS SIMULATION}
add_file write_burst_control.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
set_parameter_property ADDRESS_WIDTH SYSTEM_INFO {ADDRESS_WIDTH Data_Write_Master}
...
proc elaborate_me {}  {
  ...
  set_port_property snk_error WIDTH [get_parameter_value ERROR_WIDTH]
  ...
  if { [get_parameter_value DATA_WIDTH] == 8 }  {
    set_port_property snk_empty WIDTH 1
  } else {
  ...
  set_port_property master_writedata WIDTH [get_parameter_value DATA_WIDTH]
...
proc validate_me {}  {
  ...
  if { ([get_parameter_value BURST_ENABLE] == 1) && ([get_parameter_value MAX_BURST_COUNT] > [expr [get_parameter_value FIFO_DEPTH] / 2]) }  {
    send_message Error "You must select a FIFO size that is at least twice the maximum burst length."
  }
